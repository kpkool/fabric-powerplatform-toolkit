# Fabric and Power Platform Network Toolkit

This repository contains a read-only PowerShell validator for troubleshooting
Power Platform virtual network injection connectivity to a destination such as a
Microsoft Fabric Warehouse SQL endpoint.
